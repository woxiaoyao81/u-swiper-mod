<template>
	<view class="u-swiper-wrap" :style="{
		...
		<swiper class="u-swiper-box" :current="elCurrent" @change="change" @animationfinish="animationfinish" :interval="interval" :circular="circular" :duration="duration" :autoplay="autoplay"
